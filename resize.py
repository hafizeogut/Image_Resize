...
def crop_and_save_images(input_folder, output_folder, crop_size=(1115, 737)):
    ...
    for i, image_file in enumerate(image_files):
        ...
        new_file_name = f'image_{i+1:04d}.jpg'  # Örneğin: image_0001.jpg, image_0002.jpg, ...
...
if __name__ == "__main__":
    input_folder = "/home/hafizeogut/Desktop/images3"  # Girdi görüntülerinin olduğu klasör
    output_folder = "/home/hafizeogut/Desktop/images3"  # Çıktı görüntülerinin kaydedileceği klasör
